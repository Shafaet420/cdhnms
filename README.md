...
# 3. Auth scaffolding (login/register views + routes/auth.php referenced by routes/web.php)
composer require laravel/breeze --dev
php artisan breeze:install blade
npm install && npm run build

# 4. Spatie package migrations/config (already have config/permission.php and
...
routes/web.php, routes/console.php -> route list with permission middleware applied
```
